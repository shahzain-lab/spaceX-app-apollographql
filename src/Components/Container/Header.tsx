    ...
    return (
        <div className="bg-rocket-image flex justify-between items-center w-full h-screen backdrop-opacity-2 bg-fixed">
            <div className="text-center p-10 mb-10">
                ...
                <Link to="launches"><button className="rounded text-lg mx-1 text-white bg-purple-600 hover:bg-purple-700 px-2 py-1">Visit Launches <i className="fa fa-angle-right"></i></button></Link>
            </div>
            {/* <HeaderLeft /> */}
        </div>
    )
