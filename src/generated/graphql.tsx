...
/**
 * __useShipsDetailsQuery__
 *
 * To run a query within a React component, call `useShipsDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useShipsDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useShipsDetailsQuery({
 *   variables: {
 *   },
 * });
 */
export function useShipsDetailsQuery(baseOptions?: Apollo.QueryHookOptions<ShipsDetailsQuery, ShipsDetailsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ShipsDetailsQuery, ShipsDetailsQueryVariables>(ShipsDetailsDocument, options);
      }
export function useShipsDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ShipsDetailsQuery, ShipsDetailsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ShipsDetailsQuery, ShipsDetailsQueryVariables>(ShipsDetailsDocument, options);
        }
export type ShipsDetailsQueryHookResult = ReturnType<typeof useShipsDetailsQuery>;
export type ShipsDetailsLazyQueryHookResult = ReturnType<typeof useShipsDetailsLazyQuery>;
export type ShipsDetailsQueryResult = Apollo.QueryResult<ShipsDetailsQuery, ShipsDetailsQueryVariables>;